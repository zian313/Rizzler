...
<div style="padding-top: 120px; padding-bottom: 3rem;">
  <div style="max-width: 600px; margin: 0 auto; background: white; padding: 2rem; border-radius: 0.5rem; box-shadow: 0 2px 10px rgba(30, 9, 226, 0.1);">
    ...
    <h1 style="font-size: 2rem; font-weight: 700; margin-bottom: 2rem; color: #000;">Tambah Produk Baru</h1>
    ...
    <form method="POST" action="{{ route('products.store') }}" enctype="multipart/form-data">
      ...
      <div style="margin-bottom: 2rem;">
        ...
        <div style="position: relative;">
          ...
          <small style="display: block; margin-top: 0.5rem; color: #666;">Format: JPEG, PNG, JPG, GIF | Max: 2MB</small>
        </div>

        <div id="preview-container" style="margin-top: 1rem; display: none;">
          <p style="font-weight: 600; margin-bottom: 0.5rem; color: #000;">Preview:</p>
